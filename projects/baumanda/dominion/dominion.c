...
// *********************************************
// Assignment 2 Refactored Function Definitions
// *********************************************
smithyCard(int currentPlayer, struct gameState* state, int handPos){
//+3 Cards
int i;
  for (i = 0; i < 2; i++)
    {
...
adventurerCard(int drawntreasure, struct gameState* state, int currentPlayer, int cardDrawn, int* temphand, int z){
...
councilRoomCard(int handPos, struct gameState* state, int currentPlayer){
  //+4 Cards
  int i;
  for (i = 0; i < 4; i++)
    {
...
villageCard(int currentPlayer, struct gameState* state, int handPos){
  //+1 Card
  drawCard(currentPlayer, state);
...
greatHallCard(int currentPlayer, struct gameState* state, int handPos){
  //+1 Card
  drawCard(currentPlayer, state);
