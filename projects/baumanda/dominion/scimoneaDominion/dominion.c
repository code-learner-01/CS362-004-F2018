...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
      playAdventurer(state, currentPlayer, handPos, cardDrawn, &temphand, drawntreasure);
...
// make z = 1
int playAdventurer(struct gameState *state, int currentPlayer, int handPos, int cardDrawn, int* temphand, int drawntreasure)
{
  int z = 1; //should be z = 0
...
// in this one we can make the i less than or equal to the three, making the player draw too many cards
