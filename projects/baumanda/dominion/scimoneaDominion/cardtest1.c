...
int main() {
	...
	// Test 1: Was hand Count increased by 2?
	...
	// Test 2: Was deck count decreased by 3?
	...
	// Test 3: Was discard count increased by 1?
	if(testG.discardCount == G.discardCount + 1){
		printf("Test 3 Passed (Discard count)\n");
	} else {
		printf("Test 3 Failed (Discard count)\n");
		failCount++;
	}
